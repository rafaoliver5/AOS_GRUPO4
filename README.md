...
Este método de almacenamiento de datos es rápido y sencillo para una fase inicial, pero hemos pensado que más adelante el almacenamiento lo migraremosa una base de datos como SQLite o Oracle y lo podríamos empaquetar con Docker para su despliegue.
